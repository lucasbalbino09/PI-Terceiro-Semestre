                ...
                <div class="p-5">
                  ...
                  <div class="row mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" height="12" width="10.5" viewBox="0 0 448 512"><path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg>
                    </i>
                  </button> -->
                  {{-- <div>
                    <form action="{{ route('carrinho.adicionar', $item->Produto->PRODUTO_ID) }}" method="POST">
                      @csrf
                      @method('PUT') <!-- Use 'PUT' aqui -->
